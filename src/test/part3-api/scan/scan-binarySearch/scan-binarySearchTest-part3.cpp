#include "scan-binarySearchTest-part3.h"
...
void testScanInMemtablePart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(1, 10);
...
void testScanInStoragePart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(1, 5000);
...
void testScanInMemtableAndStoragePart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(1, MEMTABLE_SIZE + 100);
...
void testScanEmptyRangePart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(6, 100);
    assert(results.size() == 0);

    results = scan_binarySearch_part3(1, 2);
    assert(results.size() == 0);
...
void testScanOneKeyDoesNotExistPart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(1, MEMTABLE_SIZE / 2 + 10);
    ...
    results = scan_binarySearch_part3(2 * MEMTABLE_SIZE - 10, 2 * MEMTABLE_SIZE + 10);
    assert(results.size() == 11);
...
void testScanBothKeysDoNotExistPart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(4, 11);
...
void testScanMostRecentKeyInOnlyMemtablePart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(1, MEMTABLE_SIZE);
...
void testScanMostRecentKeyInMemtableAndStoragePart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(1, 2 * MEMTABLE_SIZE);
...
void testScanWithDeletedKeysPart3BinarySearch() {
    ...
    vector<KVPair> results = scan_binarySearch_part3(1, 50); 
